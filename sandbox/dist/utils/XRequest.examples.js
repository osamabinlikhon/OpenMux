 ...
 */
import { XRequestFunction, setXRequestGlobalOptions } from './XRequest';
/**
 * EXAMPLE 1: Basic Usage with Callbacks
 * ======================================
 */
async function basicUsageWithCallbacks() {
    const request = XRequestFunction('https://opencode.ai/zen/v1', {
        method: 'POST',
...
async function manualRequestControl() {
    const request = XRequestFunction('https://api.example.com/v1', {
...
async function retryWithCustomInterval() {
    const request = XRequestFunction('https://unstable-api.example.com/v1', {
        method: 'POST',
...
async function requestAbortAndEvents() {
    const request = XRequestFunction('https://slow-api.example.com/v1', {
        timeout: 120000,
    });
    // Listen to events
...
//# sourceMappingURL=XRequest.examples.js.map